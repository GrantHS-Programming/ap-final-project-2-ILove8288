...
public class GameLoop{
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        pc1.printStats();
        System.out.println("");
        System.out.println("As the world spins around you realize you have awoken in a "+startPOS[rNum]+".");

        if(startPOS[rNum].equalsIgnoreCase(startPOS[0])){
            System.out.println("As you look around you see many drunken patrons talking, laughing, and drinking.\nA large man walks up to you, \"Is it"+Colors.Green+" true"+ Colors.Reset+" you wish to leave my fine establishment?\"");
            choiceOne = checker.nextBoolean();
            if(choiceOne=true){
